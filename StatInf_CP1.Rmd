...
#Sample Mean and Variance vs. Theoretical Mean and Variance  
  ...
  These theoretical values are compared to the values from the simulated sample means in _Figure 1_. Th left panel shows a histogram of the distribution of sample means. Two lines mark the location of the center of the distribution(blue), and the theoretical center (red).  
...
_Note:_ Code for graphs not included in this report due to space limits, but markdown file can be found [here](https://github.com/anandi42/Stat_Inf/blob/master/StatInf_courseProj1.Rmd).
