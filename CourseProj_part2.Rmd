...
t1 <- data.frame( Group=c(levels(datasupp$supp), levels(datadose$dose)), Means=c(datasupp$mean[1:2], datadose$mean[1:3]), Variances=c(datasupp$var[1:2], datadose$mean[1:3]))
